...
All content and source code in this repository is the intellectual property of John Schibelli and IntraWeb Technology. Unauthorized use, copying, distribution, or modification is strictly prohibited.

This project is not open-source and does not grant permission to reuse any part of the codebase without explicit written permission.
